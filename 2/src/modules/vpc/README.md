...
| Name | Description |
|------|-------------|
| <a name="output_info_subnet"></a> [info\_subnet](#output\_info\_subnet) | info of the subnet |
| <a name="output_subnet_id"></a> [subnet\_id](#output\_subnet\_id) | info of the subnet id |
